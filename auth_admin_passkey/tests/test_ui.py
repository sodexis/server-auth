...
class TestUI(common.HttpCase):
    ...
    def test_01_normal_login_admin_succeed(self):
        ...
        self.assertIn('oe_login_form', response.data.decode("utf-8"))
        ...
        self.assertNotIn('oe_login_form', response.data.decode("utf-8"))
    ...
    def test_02_normal_login_admin_fail(self):
        ...
        self.assertIn('Wrong login/password', response.data.decode("utf-8"))
